...
metadata:
  # ...
  annotations:
    jira.com/project-keys: value # value: The key of the Jira project to track for this entity
```
...
metadata:
  # ...
  annotations:
    jira.com/project-keys: value,value,value # value: The keys of the Jira project to track for this entity
    jira.com/components: component,componen,component # Jira component name separated with a comma
